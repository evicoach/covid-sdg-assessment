...
const covid19ImpactEstimator = (data) => {
  ...
  const impactCurrentlyInfected = currentlyInfected(data.reportedCases, IMPACT);
  const severeImpactCurrentlyInfected = currentlyInfected(data.reportedCases, SEVERE_IMPACT);
